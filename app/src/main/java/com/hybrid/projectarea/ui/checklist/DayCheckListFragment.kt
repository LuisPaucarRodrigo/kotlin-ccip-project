...
class DayCheckListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.scrollChecklist.checkListMobile.setOnClickListener {
            openFragment(R.id.action_DayCheckListFragment_to_MobileCheckListFragment)
        }

        binding.scrollChecklist.checkListTools.setOnClickListener {
            openFragment(R.id.action_DayCheckListFragment_to_ToolsCheckListFragment)
        }

        binding.scrollChecklist.checkListHistory.setOnClickListener {
            openFragment(R.id.action_DayCheckListFragment_to_HistoryCheckListFragment)
        }
